...
figure(); 
subplot(1,2,1); mesh(x,y,u_new'); title('The computed solution') xlabel('x');ylabel('y');zlabel('u');grid minor 
subplot(1,2,2); mesh(x,y,u_new'-u_exact'); title('The error plot') xlabel('x');ylabel('y');zlabel('error');grid minor 
